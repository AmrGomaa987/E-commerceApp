...
import 'package:ecommerce_app_with_flutter/presentation/auth/bloc/age_selection_cubit.dart';
import 'package:ecommerce_app_with_flutter/presentation/auth/bloc/ages_display_cubit.dart';
import 'package:ecommerce_app_with_flutter/presentation/auth/bloc/gender_selection_cubit.dart';
import 'package:ecommerce_app_with_flutter/presentation/auth/widgets/ages.dart';
        ...
        child: Builder(
          builder: (context) {
            return BasicReactiveButton(
              onPressed: () {
                final selectedAge = context
                    .read<AgeSelectionCubit>()
                    .selectedAge;

                // Validate age selection
                if (selectedAge == 'Age Range' || selectedAge.isEmpty) {
                ...
                userCreationReq.gender = context
                    ...
                    .selectedIndex;
                userCreationReq.age = selectedAge;
