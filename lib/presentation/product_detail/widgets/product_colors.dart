...
class ProductColors extends StatelessWidget {
  ...
  Color _getColorFromRgb(int index) {
    if (index >= 0 && index < productEntity.colors.length) {
      final colorEntity = productEntity.colors[index];
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Expanded(
            child: productEntity.colors.isEmpty
                ? const Center(
                    child: Text(
                      'No colors available',
